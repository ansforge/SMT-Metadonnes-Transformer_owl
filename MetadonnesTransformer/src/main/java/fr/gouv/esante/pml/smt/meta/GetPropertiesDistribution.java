...
public class GetPropertiesDistribution {
	...
	//static final String inputFileName  = "catalogue_smt.rdf";
	   ...
	   public static List<String> listeDataSet = new ArrayList<String>();
		...
		public static HashMap<String, HashMap<String, List<String>>> getlistPropDistribution (String distribution) throws ParseException, IOException {	
			
			
			//listeDataSet.add("http://data.esante.gouv.fr/ontology/metadata-catalog/NABM801.0DIS");
		      ...
		      //  }	
	            ...
	            while (iter.hasNext()) {
	               ...
	               // if(subject.toString().equals("http://data.esante.gouv.fr/ontology/metadata-catalog/NCBITaxonomy2111V1.0") ) {
	                ...
	                if(subject.toString().equals(distribution) ) {	
