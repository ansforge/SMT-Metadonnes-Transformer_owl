...
public class GetTerminologyClassification {
	...
	// static final String inputFileName  = "cartography_vocabulary.rdf";
		 ...
		 private static String cartographyVocabulary = PropertiesUtil.getProperties("cartographyVocabulary");
			...
			static final String classificationType = "http://data.esante.gouv.fr/ontology/dcat-ap-ans#TerminologyClassification";
			
			
			
			public static HashMap<String, String> listePrefLabelClassification = new HashMap<String,  String>();
			
			//public static void main (String args[]) {
				
			public static void getListeLabelClassification () {	
		        ...
		        while (iter.hasNext()) {
		            ...
		            if(rdfType.equals(predicate.toString())
		            		&& classificationType.equals(object.toString()))
		            {
		            	//System.out.println("* "+subject.toString());
		            	//System.out.println("** "+subject.getProperty(SKOS.prefLabel).getString());
		            	 listePrefLabelClassification.put(subject.toString(), subject.getProperty(SKOS.prefLabel).getString());
		            }
